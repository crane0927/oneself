...
import com.oneself.mapper.ConstraintMapper;
import com.oneself.mapper.UserRoleMapper;
import com.oneself.model.dto.ConstraintDTO;
import com.oneself.model.dto.ConstraintQueryDTO;
import com.oneself.model.enums.ConstraintTypeEnum;
import com.oneself.model.enums.StatusEnum;
import com.oneself.model.pojo.Constraint;
import com.oneself.model.vo.ConstraintVO;
...
public class ConstraintServiceImpl implements ConstraintService {
    ...
    public void checkRolePrerequisiteConstraint(String userId, List<String> roleIds) {
        // 查询用户当前已有的角色
        List<com.oneself.model.pojo.UserRole> existingUserRoles = userRoleMapper.selectList(
                new LambdaQueryWrapper<com.oneself.model.pojo.UserRole>()
                        .eq(com.oneself.model.pojo.UserRole::getUserId, userId)
        );
        Set<String> existingRoleIds = existingUserRoles.stream()
                .map(com.oneself.model.pojo.UserRole::getRoleId)
